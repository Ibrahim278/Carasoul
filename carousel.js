var maximages = 5;
var startpath = "pix3/birds" //Filename extension of each image.
var extension = ".png"
//Show clicked image in the large img tag
//Calculates which picture to show next based on x //which is either 1 or -1.
function calcslide(x) {
    //Get file name of image that's showing.
    var currentimage = document.getElementById('bigpic').src; var path = 'pix3/birds' + z + '.png';
    var z = '0' + x;
    var y = '' + 10;
    ...
    var stringnumber = currentimage.substr(dotat - 2, 2); //Convert stringnumber string to number and add x.
    ...
    var twodigitnum = ('0' + nextnum).slice(-2); //Create new file name from two-digit number string. 
